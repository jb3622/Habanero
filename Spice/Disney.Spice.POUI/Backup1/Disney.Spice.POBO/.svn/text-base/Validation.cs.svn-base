...
namespace Disney.Spice.POBO
{
    public class Validation
    {
        ...
        {
            if (ipcurrencycls == null) ipcurrencycls = new IPCURCY(_PgmDB);
        ...
        //public String GetItemDescription(Int16 Class, Int32 Vendor, Int16 Style, Int16 Colour, Int16 Size, String Market)
        //{
        //    ItemsBO.Items itembo = new Disney.Spice.ItemsBO.Items(_PgmDB, _username, _paramenv);
        //    itembo.GetItem(Class, Vendor, Style, Colour, Size, Market);

        //    return itembo.ItemLongDescription;
        //}
    }
}